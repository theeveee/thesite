...
parcelRequire = (function (modules, cache, entry, globalName) {
    ...
    */
    ...
    var MenuItem = /*#__PURE__*/function () {
      function MenuItem(el, inMenuPosition, animatableProperties) {
        ...
        this.imagePath = this.DOM.el.dataset.img;
      ...
      _createClass(MenuItem, [{
        ...
        value: function layout() {
          ...
          this.DOM.revealImage.style.backgroundImage = "url(".concat(this.imagePath, ")");
    ...
    var Menu = /*#__PURE__*/function () {
      function Menu(el) {
        ...
        this.DOM.menuItems = this.DOM.el.querySelectorAll('.hover'); // menu item properties that will animate as we move the mouse around the menu
    ...
    // menu (<nav> element)
    // var menuEl = document.querySelector('.hoverItem'); // preload the images set as data attrs in the menu items
    var menuEls = document.querySelectorAll('.hoverItem');

    (0, _preloader.preloader)('.hover').then(function () {
  ...
  }, { "./cursor": "LMRJ", "./preloader": "BeZ8", "locomotive-scroll": "ez7q", "./menu": "i0CD" }]
}, {}, ["QvaY"], null)